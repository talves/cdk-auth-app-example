 ...
 */
const getGroupsCustomAttributeName = () =>
  process.env.GROUPS_ATTRIBUTE_CLAIM_NAME || "custom:groups";
 ...
 * @param groupsFromIdP
 */
const parseGroupsAttribute = (groupsFromIdP /*: string */) /*: string[] */ => {
  if (groupsFromIdP) {
...
module.exports = { getGroupsCustomAttributeName, parseGroupsAttribute };
