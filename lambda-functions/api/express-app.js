...
const { DynamoDBStorageService } = require("./services/dynamoDBStorageService");
const {
  DynamoDBForcedSignoutHandler,
} = require("./services/dynamoDBForcedSignoutHandler");
...
const expressApp = new App({
  ...
  forceSignOutHandler: process.env.USERS_TABLE_NAME
    ? new DynamoDBForcedSignoutHandler(process.env.USERS_TABLE_NAME)
    : undefined,
